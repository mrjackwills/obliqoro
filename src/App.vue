<template>
	<v-app id='obliqoro' class='ma-0 pa-0 fill-height unselectable'>
		<v-main>
...
import type { BuildInfo, CpuMeasure, FrontEndState, ShowTimer } from '@/types'
import { invoke } from '@tauri-apps/api/core'
import { listen } from '@tauri-apps/api/event'
import { useRouter } from 'vue-router'
import { snackError } from '@/services/snack'
import { FrontEndRoutes, InvokeMessage, ListenMessage } from '@/types'
